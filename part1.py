...
price_and_url = soup.find_all('a', class_='a-size-base a-link-normal s-underline-text s-underline-link-text s-link-style a-text-normal')
...
with open('20_products.csv', 'w', newline='', encoding='utf-8-sig') as csvfile:
    ...
    for i in range(20):
        product_url = "https://amazon.in" + price_and_url[i].attrs['href'] 
